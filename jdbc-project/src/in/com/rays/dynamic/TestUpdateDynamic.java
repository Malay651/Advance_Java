...
public class TestUpdateDynamic {
	public static void main(String[] args) throws Exception {
		// testUpdate1();
		// testUpdate2();
		// testUpdate3(113,"aditya",65,85,95);
	...
	public static void testUpdate1() throws Exception {
		...
		PreparedStatement pstmt = conn.prepareStatement(
				"update marksheet set rollNo = 112,name= xyz,physics=15,chemistry=15,maths=15 where id = 11");
	...
	public static void testUpdate2() throws Exception {
		...
		PreparedStatement pstmt = conn
				.prepareStatement("update marksheet set rollNo = ?,name = ?,physics=?,chemistry=?,maths=? where id =?");
		pstmt.setInt(1, 110);
